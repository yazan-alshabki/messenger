...
!(function(e, t) {
  ...
  (w.fn = w.prototype = {
    ...
    for (
      "boolean" == typeof a &&
        ((l = a), (a = arguments[u] || {}), u++), "object" == typeof a ||
        g(a) ||
        (a = {}), u === s && ((a = this), u--);
      u < s;
      u++
  ...
  var E = (function(e) {
      ...
      if (
        ...
        if (n.qsa && !k[e + " "] && (!v || !v.test(e))) {
          if (1 !== C) (m = t), (y = e);
            ...
            (c = t.getAttribute("id"))
              ? (c = c.replace(te, ne))
              : t.setAttribute("id", (c = x)), (u = (h = a(e)).length);
              ...
              (
                se(function(e) {
                  (h.appendChild(e).innerHTML =
                    ...
                    "'></a><select id='" +
                    x +
                    "-\r\\' msallowcapture=''><option selected=''></option></select>"), e.querySelectorAll("[msallowcapture^='']").length && v.push("[*^$]=" + I + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || v.push("\\[" + I + "*(?:value|" + H + ")"), e.querySelectorAll("[id~=" + x + "-]").length || v.push("~="), e.querySelectorAll(":checked").length || v.push(":checked"), e.querySelectorAll("a#" + x + "+*").length || v.push(".#.+[+~]");
                }),
                se(function(e) {
                  e.innerHTML =
                  ...
                  t.setAttribute(
                    "type",
                    "hidden"
                  ), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && v.push("name" + I + "*[*^$|!~]?="), 2 !== e.querySelectorAll(":enabled").length && v.push(":enabled", ":disabled"), (h.appendChild(e).disabled = !0), 2 !== e.querySelectorAll(":disabled").length && v.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), v.push(",.*:");
                })
              ),
    ...
    function ve() {}
    (ve.prototype = r.filters =
      r.pseudos), (r.setFilters = new ve()), (a = oe.tokenize = function(e, t) {
      var n,
        i,
        o,
        a,
    ...
    function Ce(e, t, n, r, i, o) {
      return r && !r[x] && (r = Ce(r)), i &&
        !i[x] &&
        (i = Ce(i, o)), ue(function(o, a, u, s) {
        var l,
          c,
          f,
          d = [],
    ...
    return (u = oe.compile = function(e, t) {
      ...
      x.split("").sort(A).join("") ===
      x), (n.detectDuplicates = !!f), d(), (n.sortDetached = se(function(e) {
    ...
    function(e, t) {
      w.fn[e] = function(n, r) {
        ...
        return "Until" !== e.slice(-5) && (r = n), r &&
          ...
          (P[e] || w.uniqueSort(i), O.test(e) && i.reverse()), this.pushStack(
          i
        );
      };
    }
          ...
          then: function(t, r, i) {
            ...
            return w
              .Deferred(function(e) {
                ...
                ), n[1][3].add(a(0, e, g(t) ? t : B)), n[2][3].add(a(0, e, g(r) ? r : M));
              })
              .promise();
          },
          promise: function(e) {
  ...
  w.extend({
    ...
    queue: function(e, t, n) {
      var r;
      if (e)
        return (t = (t || "fx") + "queue"), (r = K.get(e, t)), n &&
          (!r || Array.isArray(n)
  ...
  function se(e, t, n, r) {
    ...
    if (c && c[3] !== l) {
      (s /= 2), (l = l || c[3]), (c = +s || 1);
      while (a--)
        w.style(e, t, c + l), (1 - o) * (1 - (o = u() / s || 0.5)) <= 0 &&
          (a = 0), (c /= o);
    ...
    for (
      ...
      if ((o = e[p]) || 0 === o)
        if ("object" === b(o)) w.merge(d, o.nodeType ? [o] : o);
          ...
          (a = a || f.appendChild(t.createElement("div"))), (u = (pe.exec(
            o
          ) || ["", ""])[1]
            .toLowerCase()), (s = ge[u] || ge._default), (a.innerHTML =
            s[1] + w.htmlPrefilter(o) + s[2]), (c = s[0]);
  ...
  (w.event = {
    ...
    add: function(e, t, n, r, i) {
      ...
      if (v) {
        n.handler && ((n = (o = n).handler), (i = o.selector)), i &&
          w.find.matchesSelector(xe, i), n.guid || (n.guid = w.guid++), (s =
          v.events) || (s = v.events = {}), (a = v.handle) ||
      ...
      if (v && (s = v.events)) {
        ...
        while (l--)
          if (
            ...
            (f = w.event.special[p] || {}), (d =
              s[(p = (r ? f.delegateType : f.bindType) || p)] || []), (u =
              u[2] &&
              new RegExp(
                "(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"
              )), (a = o = d.length);
    ...
    handlers: function(e, t) {
      ...
      return (l = this), s < t.length &&
        u.push({ elem: l, handlers: t.slice(s) }), u;
    },
    ...
    off: function(e, t, n) {
      ...
      return (!1 !== t && "function" != typeof t) ||
        ((n = t), (t = void 0)), !1 === n && (n = Ne), this.each(function() {
  ...
  function Re(e, t, n, r) {
    ...
    if (
      ...
      for (s = (u = w.map(ve(i, "script"), Oe)).length; f < d; f++)
        (l = i), f !== p &&
          ((l = w.clone(l, !0, !0)), s && w.merge(u, ve(l, "script"))), n.call(
          e[f],
          l,
          f
        );
  ...
  function Be(e, t, n) {
    for (var r, i = t ? w.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || w.cleanData(ve(r)), r.parentNode &&
        (
  ...
  w.extend({
    ...
    clone: function(e, t, n) {
      ...
      return (a = ve(u, "script")).length > 0 &&
        ye(a, !s && ve(e, "script")), u;
    },
    ...
    function(e, t) {
      w.fn[e] = function(e) {
        for (var n, r = [], i = w(e), o = i.length - 1, a = 0; a <= o; a++)
          (n = a === o ? this : this.clone(!0)), w(i[a])[t](n), u.apply(
            r,
            n.get()
          );
    ...
    function t() {
      if (c) {
        (l.style.cssText =
          ...
          "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%"), xe
          .appendChild(l)
          .appendChild(c);
        var t = e.getComputedStyle(c);
        (i = "1%" !== t.top), (s = 12 === n(t.marginLeft)), (c.style.right =
          "60%"), (u = 36 === n(t.right)), (o =
          36 === n(t.width)), (c.style.position = "absolute"), (a =
          36 === c.offsetWidth || "absolute"), xe.removeChild(l), (c = null);
      }
    }
    function n(e) {
  ...
  function Ze(e, t, n, r, i, o) {
    ...
    for (; a < 4; a += 2)
      "margin" === n && (s += w.css(e, n + oe[a], !0, i)), r
        ? (
  ...
  w.extend({
    ...
    css: function(e, t, n, r) {
      var i,
        ...
        a,
        u = Q(t);
      return Ue.test(t) || (t = Ke(u)), (a = w.cssHooks[t] || w.cssHooks[u]) &&
        "get" in a &&
    ...
    w.cssHooks[t] = {
      ...
      set: function(e, n, r) {
        ...
        return a &&
          ...
          (i = ie.exec(n)) &&
          "px" !== (i[3] || "px") &&
          ((e.style[t] = n), (n = w.css(e, t))), Je(e, n, u);
      }
    };
    ...
    trigger: function(t, n, i, o) {
      ...
      if (
        ...
        while ((u = y[a++]) && !t.isPropagationStopped())
          (h = u), (t.type = a > 1 ? l : p.bindType || m), (d =
  ...
  (w.param = function(e, t) {
    ...
    setOffset: function(e, t, n) {
      var r,
        ...
        d = {};
      "static" === c &&
        (e.style.position = "relative"), (u = f.offset()), (o = w.css(
        e,
        "top"
      )), (s = w.css(e, "left")), (l =
        ("absolute" === c || "fixed" === c) && (o + s).indexOf("auto") > -1)
        ? ((a = (r = f.position()).top), (i = r.left))
        : ((a = parseFloat(o) || 0), (i = parseFloat(s) || 0)), g(t) &&
        (t = t.call(e, n, w.extend({}, u))), null != t.top &&
        (d.top = t.top - u.top + a), null != t.left &&
        (d.left = t.left - u.left + i), "using" in t
        ? t.using.call(e, d)
        : f.css(d);
    }
  }), w.fn.extend({
  ...
  }), (w.isArray = Array.isArray), (w.parseJSON = JSON.parse), (w.nodeName = D), (w.isFunction = g), (w.isWindow = v), (w.camelCase = Q), (w.type = b), (w.now = Date.now), (w.isNumeric = function(
    e
  ) {
    var t = w.type(e);
